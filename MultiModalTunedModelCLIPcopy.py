...
MODEL_SAVE_PATH = 'best_clip_classifier_2.safetensors' 
...
plt.tight_layout()
plt.savefig('images/accuracyCLIP2.png' ,dpi=300, bbox_inches='tight')
...
plt.savefig('images/confusionMatrixClip2.png', dpi=300, bbox_inches='tight')
